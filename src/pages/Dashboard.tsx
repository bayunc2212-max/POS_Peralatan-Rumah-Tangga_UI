    ...
    return (
      <div className="p-6 max-w-2xl mx-auto mt-12 animate-fade-in">
        <div className="bg-white rounded-2xl border border-stone-200/70 shadow-sm p-10 text-center">
          ...
          <h1 className="text-xl font-semibold text-stone-900 mb-2">Selamat Datang, Kasir</h1>
          <p className="text-stone-500 mb-6">Silakan buka menu POS untuk memulai transaksi</p>
          <Link
            to="/pos"
